...
@section('title',__('adserver::adserver.add_ad_space'))
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('adserver::adserver.add_ad_space') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('adserver::adserver.add_ad_space') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.ad_spaces.store') }}" method="post">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="code" name="code" required
                                       value="{{ old('code') }}" autofocus tabindex="1"
