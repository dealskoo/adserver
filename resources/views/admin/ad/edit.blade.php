                                ...
                                <div class="row">
                                        ...
                                        <select id="ad_space_id" name="ad_space_id" class="form-control select2"
                                            ...
                                            @foreach($ad_spaces as $ad_space)
                                                @if($ad->ad_space_id == $ad_space->id)
                                                    <option value="{{ $ad_space->id }}"
                                                            selected>{{ $ad_space->code }}</option>
                                                @else
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control date" id="activity_date"
                                               ...
                                               value="{{ old('activity_date',\Carbon\Carbon::parse($ad->start_at)->format('m/d/Y').' - '.\Carbon\Carbon::parse($ad->end_at)->format('m/d/Y')) }}"
                                               required
                                               tabindex="5">
                                    </div>
                                </div>
