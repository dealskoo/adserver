...
@section('title',__('adserver::adserver.add_ad'))
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('adserver::adserver.add_ad') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('adserver::adserver.add_ad') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
                            ...
                            <div class="col-4">
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        <div class="cover-box">
                                            <img src="{{ asset(config('adserver.default_banner')) }}"
                            ...
                            <div class="col-8">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control date" id="activity_date"
                                               name="activity_date"
